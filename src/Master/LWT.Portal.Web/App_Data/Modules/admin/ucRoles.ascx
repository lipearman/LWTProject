<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucRoles.ascx.vb" Inherits="LWT.Portal.Web.ucRoles" %>
                                    ...
                                    <PanelCollection>
                                        <dx:PanelContent ID="PanelContent1">
                                            ...
                                            <dx:ASPxTreeList ID="treeList" runat="server" ClientInstanceName="treeList" SettingsLoadingPanel-Enabled="false"
                                                ...
                                                Width="100%" SettingsBehavior-AutoExpandAllNodes="true"
                                                KeyFieldName="TabId"
                                                ParentFieldName="ParentId">
                                                <Columns>
                                                    <dx:TreeListMemoColumn FieldName="TabName" Width="500" CellStyle-Wrap="True">
