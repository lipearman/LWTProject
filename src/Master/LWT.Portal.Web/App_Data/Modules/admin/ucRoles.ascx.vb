...
Public Class ucRoles
    ...
    Protected Sub tree_CustomCallback(ByVal sender As Object, ByVal e As TreeListCustomCallbackEventArgs) Handles tree.CustomCallback
        ...
        Select Case e.Argument
            Case "cmdEdit"
                ...
                Dim _PortalId As Integer = CInt(tree.FocusedNode.GetValue("PortalId"))
    ...
    Protected Sub tree_CommandColumnButtonInitialize(ByVal sender As Object, ByVal e As TreeListCommandColumnButtonEventArgs) Handles tree.CommandColumnButtonInitialize
        'If e.ButtonType <> TreeListCommandColumnButtonType.Custom Or e.ButtonType <> TreeListCommandColumnButtonType.New Then
        '    Return

        'End If

        'If e.ButtonType = TreeListCommandColumnButtonType.Custom And e.NodeKey < 0 Then
    ...
    '    If _ParentId < 0 Then
    '        _PortalId = _ParentId * -1
    '        _ParentId = 1
    '    Else
    '        Using dc As New DataClasses_PortalDataContextExt()
    '            Dim _role_data = (From c In dc.Portal_Roles Where c.RoleID.Equals(_ParentId)).FirstOrDefault()
    '            If _role_data IsNot Nothing Then
    '                _PortalId = _role_data.PortalID
    '            End If
    '        End Using
    '    End If
    ...
    '    e.NewValues("PortalId") = _PortalId
    ...
    'Protected Sub treeList_CustomCallback(ByVal sender As Object, ByVal e As TreeListCustomCallbackEventArgs) Handles treeList.CustomCallback
    ...
    'Protected Sub grid_CustomCallback(ByVal sender As Object, ByVal e As DevExpress.Web.ASPxGridViewCustomCallbackEventArgs) Handles grid.CustomCallback
    ...
    '    If e.ButtonID <> "cmdEdit" Then
    '        Return
    '    End If
    '    Dim RoleID = grid.GetRowValues(e.VisibleIndex, "RoleID").ToString()
    '    Dim RoleName = grid.GetRowValues(e.VisibleIndex, "RoleName").ToString()
    '    Session("RoleID") = RoleID
    '    displayRole.Text = RoleName
    'End Sub
    ...
    Protected Sub callbackPanel_tabs_Callback(ByVal source As Object, ByVal e As DevExpress.Web.CallbackEventArgsBase) Handles callbackPanel_tabs.Callback
        ...
        PortalId = CInt(tree.FocusedNode.GetValue("PortalId").ToString())
    ...
    Protected Sub cbSaveTabRoles_Callback(ByVal sender As Object, ByVal e As CallbackEventArgs) Handles cbSaveTabRoles.Callback
        ...
        Dim _PortalID = CInt(Session("PortalId"))

        Using dc As New DataClasses_PortalDataContextExt()
            Dim _Tabs = (From c In dc.PortalCfg_Tabs Where c.PortalId = _PortalID).ToList()
