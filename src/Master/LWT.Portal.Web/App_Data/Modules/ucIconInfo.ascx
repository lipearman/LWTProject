<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucIconInfo.ascx.vb" Inherits="LWT.Portal.Web.ucIconInfo" %>
...
<dx:ASPxGridView ID="gridView" runat="server" ClientInstanceName="grid" AutoGenerateColumns="false"
    KeyFieldName="FullIconID" Width="1200" OnCustomCallback="gridView_CustomCallback">
