<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="ucSiteSettings.ascx.vb" Inherits="LWT.Portal.Web.ucSiteSettings" %>
        ...
        <dx:PanelContent>
            ...
            <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="SqlDataSource_Project"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="cfg_conn" CellStyle-Wrap="True">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="cfg_query_user" CellStyle-Wrap="True">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="cfg_url_passport" CellStyle-Wrap="True">
                    </dx:GridViewDataTextColumn>
...
<asp:SqlDataSource ID="SqlDataSource_Project" runat="server" ConnectionString="<%$ ConnectionStrings:PortalConnectionString %>"
    SelectCommand="select * from PortalCfg_Globals"
