...
Partial Public Class DataClasses_PortalBIDataContext
  ...
  #End Region
	...
	Public Sub New()
		MyBase.New(Global.System.Configuration.ConfigurationManager.ConnectionStrings("Portal_BIConnectionString1").ConnectionString, mappingSource)
		OnCreated
	End Sub
...
Partial Public Class tblDashBoard_DataSource
    ...
    End Sub
    Partial Private Sub OnDB_CONNChanging(value As String)
    End Sub
    Partial Private Sub OnDB_CONNChanged()
    End Sub
    #End Region
	...
	<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_DB_CONN", DbType:="VarChar(255)")>  _
	Public Property DB_CONN() As String
		Get
			Return Me._DB_CONN
		End Get
		Set
			If (String.Equals(Me._DB_CONN, value) = false) Then
				Me.OnDB_CONNChanging(value)
				Me.SendPropertyChanging
				Me._DB_CONN = value
				Me.SendPropertyChanged("DB_CONN")
				Me.OnDB_CONNChanged
			End If
		End Set
	End Property
