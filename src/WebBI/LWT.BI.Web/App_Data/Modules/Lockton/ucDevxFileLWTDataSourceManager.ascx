<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxFileLWTDataSourceManager.ascx.vb" Inherits="Modules_ucDevxFileLWTDataSourceManager" %>
<script>
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIConnection %>"
    SelectCommand="select * from tblDataSourceFile where Owner=@UserName">
    <SelectParameters>
