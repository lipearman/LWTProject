...
<asp:SqlDataSource ID="SqlDataSource_Report" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIConnection %>"
    SelectCommand="
  SELECT dbo.tblDashBoard.[DB_ID]
        , dbo.tblDashBoard.No
        , dbo.tblDashBoard.TITLE
        , dbo.tblDashBoard.DESCRIPTION
        , dbo.tblDashBoard.DEPARTMENT
        , dbo.tblDashBoard.ParentID
        , dbo.tblDashBoard.[DB_ID]
        , dbo.tblDashBoard_Assignment.UserName
        , case when tblDashBoard_Assignment.UserName IS not null then tblDashBoard.[DB_ID] end SelectRID

    FROM  dbo.tblDashBoard 
    left JOIN dbo.tblDashBoard_Assignment ON dbo.tblDashBoard.[DB_ID] = dbo.tblDashBoard_Assignment.[DB_ID]    
    and UserName=@UserName
    order by dbo.tblDashBoard.[No]
    ">
    <SelectParameters>
