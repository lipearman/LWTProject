<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxDimention.ascx.vb" Inherits="Modules_ucDevxDimention" %>
        ...
        <dx:PanelContent>
            ...
            <dx:ASPxGridView ID="grid" 
                ...
                <Columns> 
                    ...
                    <dx:GridViewDataTextColumn FieldName="DIMENSION"  Settings-AllowGroup="False"  CellStyle-Wrap="False"></dx:GridViewDataTextColumn>
                </Columns>
            </dx:ASPxGridView>
...
<asp:SqlDataSource ID="SqlDataSource_Data" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIConnection %>"
    ...
    ,tblDimention.[DIMENSION] 

    from tblDimention 

    inner join tblCube on tblDimention.CUBE_ID = tblCube.CUBE_ID
