<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxFileBIMasterSetup.ascx.vb" Inherits="Modules_ucDevxFileBIMasterSetup" %>
        ...
        <dx:PanelContent>
            ...
            <dx:ASPxTreeList ID="treeList"
                ...
                <Columns>
                    ...
                    <dx:TreeListHyperLinkColumn FieldName="BID" Caption="TITLE" Width="300">
...
<%--                    <dx:TreeListSpinEditColumn FieldName="No" Visible="false" Caption="No" 
                        ...
                        <PropertiesSpinEdit Width="100" Height="10" MinValue="1" MaxValue="99">
                    ...
                    <dx:TreeListTextColumn FieldName="DESCRIPTION" Caption="DESCRIPTION" Width="200"  CellStyle-Wrap="False">
                        <PropertiesTextEdit Width="400">
                            <ValidationSettings Display="Dynamic">
                                <RequiredField IsRequired="true" />
                            </ValidationSettings>
                    ...
                    <dx:TreeListComboBoxColumn FieldName="DS_ID"  Caption="DataSource" Width="150" CellStyle-Wrap="False">
                        ...
                        <PropertiesComboBox Width="400" DataSourceID="SqlDataSource_DataSourceFile" TextField="Title" ValueField="DS_ID" ValueType="System.Int32">
                        </PropertiesComboBox>
                    </dx:TreeListComboBoxColumn>

                      <dx:TreeListTextColumn FieldName="Owner" Caption="Owner" Width="100" CellStyle-Wrap="False">
                         <EditFormSettings Visible="False" VisibleIndex="3" />
                    </dx:TreeListTextColumn>

              <%--        <dx:TreeListTextColumn FieldName="ASATDATE" Caption="ASATDATE" Width="100" PropertiesTextEdit-DisplayFormatString="{0:yyyy-MM-dd}" CellStyle-Wrap="False">
                         <EditFormSettings Visible="False" VisibleIndex="3" />
                    </dx:TreeListTextColumn>--%>
                    ...
                    <dx:TreeListCommandColumn ButtonType="Button">
