<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxFileDataSourceManager.ascx.vb" Inherits="Modules_ucDevxFileDataSourceManager" %>
<script>
...
<asp:SqlDataSource ID="SqlDataSource_COLUMN_NAME" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIRawDataConnection %>"
    SelectCommand="
        ...
        and COLUMN_NAME collate SQL_Latin1_General_CP1_CI_AS not in(
          ...
          FROM [eGlobal].[dbo].[tblDataSourceFile]
          inner join [eGlobal].[dbo].tblDataSourceFile_Field on [tblDataSourceFile].ID = tblDataSourceFile_Field.DS_ID
          where GUID=@DSGUID
    )
    ">
    <SelectParameters>
                                                        ...
                                                        <Items>
                                                            ...
                                                            <dx:GridViewToolbarItem BeginGroup="true">
                                                                <Template>
                                                                    ...
                                                                    <dx:ASPxButton runat="server" CausesValidation="false" Image-IconID="actions_cancel_16x16office2013"
