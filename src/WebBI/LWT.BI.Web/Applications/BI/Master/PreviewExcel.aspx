<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Applications/AppMasterPage.master" CodeFile="PreviewExcel.aspx.vb" Inherits="applications_BI_Master_PreviewExcel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <PanelCollection>
            <dx:PanelContent>
                ...
                <dx:ASPxPivotGrid ID="pivotGrid" runat="server"
                    ...
                    Width="100%"
                    DataSourceID="GetExcelPivotData"
                    ClientIDMode="AutoID"
    ...
    <dx:ASPxPopupControl ID="popPivot" ClientInstanceName="popPivot" runat="server"
        ...
        Modal="True" AllowResize="true" ShowMaximizeButton="true"
    ...
    <dx:ASPxPopupControl ID="ASPxPopupControl1" ClientInstanceName="DrillDownWindow"
        Modal="true" Maximized="true"
        runat="server"
        Height="1px"
        AllowDragging="True"
        Left="200" Top="200"
        CloseAction="CloseButton" ShowMaximizeButton="true"
        Width="600" MaxHeight="1000"
            ...
            <dx:PopupControlContentControl ID="PopupControlContentControl3" runat="server">
                ...
                <dx:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
                    ...
                    <%--
                       ...
                       <dx:GridViewDataTextColumn FieldName="PLY_REGION" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_COUNTRY" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_COVER_NO" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_VER_NO" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_TRANSACTION_TYPE" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_EFF_DATE" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_REN_DATE" />
                        <dx:GridViewDataTextColumn FieldName="PLY_GROSS_PREMIUM_LC" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_NET_INCOME_LC" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_STATUS" CellStyle-Wrap="False" />
                        <dx:GridViewDataTextColumn FieldName="PLY_REN_YEAR" CellStyle-Wrap="False" />
    ...
    <dx:ASPxGridViewExporter runat="server" ID="GridDrillDownExporter" GridViewID="ASPxGridView1">
        <Styles>
