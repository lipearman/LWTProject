...
End Class
Partial Public Class DataClasses_PortalBIRawdataExt
    Inherits DataClasses_PortalBIRawdataDataContext
    Private Shared ReadOnly Property ConnectionString() As String
        Get
            Dim Conn As String = ConfigurationManager.ConnectionStrings("PortalBIRawDataConnection").ConnectionString
