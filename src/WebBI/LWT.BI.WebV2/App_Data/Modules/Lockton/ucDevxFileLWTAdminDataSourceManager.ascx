<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxFileLWTAdminDataSourceManager.ascx.vb" Inherits="Modules_ucDevxFileLWTAdminDataSourceManager" %>
<script>
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIConnection %>"
    SelectCommand="select * from tblDataSourceFile">
...
<asp:SqlDataSource ID="SqlDataSource_Fields" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIConnection %>"
    SelectCommand="select * from tblDataSourceFile_Field Where DS_ID=@DS_ID order by FIELD_ID desc"
