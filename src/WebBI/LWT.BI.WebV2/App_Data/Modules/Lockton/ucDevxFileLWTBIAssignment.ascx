<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxFileLWTBIAssignment.ascx.vb" Inherits="Modules_ucDevxFileLWTBIAssignment" %>
...
where tblDataSourceBI.Owner=@UserName 
