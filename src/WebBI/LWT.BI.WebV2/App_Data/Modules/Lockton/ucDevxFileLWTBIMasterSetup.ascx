<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxFileLWTBIMasterSetup.ascx.vb" Inherits="Modules_ucDevxFileLWTBIMasterSetup" %>
...
<asp:SqlDataSource ID="SqlDataSource_DataSourceFile"
    ...
    SelectCommand="
        ...
        select [ID] as [DS_ID] 
        ,[Title]
        from tblDataSourceFile where Owner=@UserName
    order by [Title] 
