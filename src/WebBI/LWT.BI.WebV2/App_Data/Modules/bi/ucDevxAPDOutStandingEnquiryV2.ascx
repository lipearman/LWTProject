<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxAPDOutStandingEnquiryV2.ascx.vb" Inherits="Modules_ucDevxAPDOutStandingEnquiryV2" %>
<script>
...
<asp:SqlDataSource ID="SqlDataSource_RawData" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIRawDataConnection %>"
    SelectCommand="select * from V_Accounting_Outstanding"></asp:SqlDataSource>
