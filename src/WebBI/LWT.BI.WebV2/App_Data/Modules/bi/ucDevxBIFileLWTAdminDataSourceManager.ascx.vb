...
Partial Class Modules_ucDevxBIFileLWTAdminDataSourceManager
    ...
    'Protected Sub Common_Init(ByVal sender As Object, ByVal e As EventArgs) Handles ASPxTokenBox1.Init
    '    Dim tb = DirectCast(sender, ASPxTokenBox)
    '    If tb.ReadOnly Or Not tb.ClientEnabled Then
    '        tb.ControlStyle.CssClass = "disable"
    '    End If
    'End Sub
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        End If
        SqlDataSource_gridData.SelectParameters("PortalId").DefaultValue = portalSettings.PortalId
    ...
    Protected Sub cbDeleteCalculationFields_Callback(ByVal sender As Object, ByVal e As CallbackEventArgs) Handles cbDeleteCalculationFields.Callback
