                ...
                <Toolbars>
                    <dx:TreeListToolbar Enabled="true" Position="Top" ItemAlign="Left">
                        <Items>
                            ...
                            <dx:TreeListToolbarItem Command="NewRoot" Text="New Title" BeginGroup="true" Image-IconID="mail_newmail_16x16office2013" />
                            <dx:TreeListToolbarItem Command="New" Text="New Report" BeginGroup="true" Image-IconID="mail_send_16x16office2013" />
