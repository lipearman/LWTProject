    ...
    <PanelCollection>
        <dx:PanelContent>
            ...
            <dx:ASPxTreeList ID="treeList"
                ...
                KeyFieldName="DB_ID"  PreviewFieldName="Notes" Settings-ShowTreeLines="true"
        ...
        SELECT distinct
         ...
         ,'Title : ' + STUFF(
            (
                ...
                where [tblDashBoard_Data].[DB_GUID] collate Thai_CI_AS =[V_Dashboard_Assignment].[DB_GUID] 
                FOR XML PATH (''), TYPE
