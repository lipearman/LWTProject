    ...
    <ClientSideEvents CallbackError="function(s, e) { 
        ...
        CallbackComplete="function(s, e) { 
            ...
            else
            {
                ...
                window.top.clientView2.SetContentUrl('applications/DB/Master/Preview.aspx');
...
<dx:ASPxRoundPanel ID="pnMain" EnableAnimation="true" ShowCollapseButton="true" HeaderText="" runat="server" EnableAdaptivity="true" Width="100%" HeaderImage-IconID="businessobjects_bonote_32x32">
    <PanelCollection>
        <dx:PanelContent>
            ...
            <dx:ASPxTreeList ID="treeList"
                ...
                KeyFieldName="DB_ID"  PreviewFieldName="Notes"
                                ...
                                <Template>
                                    ...
                                    <dx:ASPxButton ID="ASPxButton1"
                                        ...
                                        Text="New Title"
                                         ...
                                         BackColor="White" Border-BorderWidth="1" Border-BorderColor="#dfdfdf" ForeColor="Black" 
                            ...
                            <Template>
                             ...
                             <dx:TreeListToolbarItem BeginGroup="true">
                                <Template>
                                    ...
                                    <dx:ASPxButton ID="bnDelete"
                                        ClientInstanceName="bnDelete"
                                        ...
                                        <ClientSideEvents Click="function(s,e){ 
                                          ...
                                          cbDeleteData.PerformCallback(treeList.GetFocusedNodeKey());
 ...
 <%--                   <dx:TreeListHyperLinkColumn FieldName="DB_ID" Caption="TITLE">
                    ...
                    <dx:TreeListTextColumn  FieldName="DB_ID" Caption="TITLE" >
                        <DataCellTemplate>
                             <%# GetURL(Eval("DB_ID"))%>
                        </DataCellTemplate>
...
<%--                    <dx:TreeListComboBoxColumn FieldName="CUBE_ID"  Caption="CUBE" Width="300" CellStyle-Wrap="False">
...
<asp:SqlDataSource ID="SqlDataSource_Data" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIConnection %>"
 ...
 ,'Title : ' + STUFF(
    (
        SELECT ', ' + [tblDashBoard_Data].[Caption]
        FROM [tblDashBoard_Data] 
        where [tblDashBoard_Data].[DB_GUID] collate Thai_CI_AS =[tblDashBoard].[GUID] 
        FOR XML PATH (''), TYPE
...
<%--        DeleteCommand="
    delete tblDashBoard_Data where DB_GUID in(select convert(varchar,GUID) as [GUID] from tblDashBoard where DB_ID =@DB_ID);
                                        ...
                                        <dx:LayoutItem Caption="DataSource">
                                            <LayoutItemNestedControlCollection>
                                                <dx:LayoutItemNestedControlContainer>
                                                    ...
                                                    <dx:ASPxComboBox ID="newDataSource" Width="200"  runat="server" DataSourceID="SqlDataSource_Cubes" TextField="BASE_CUBE_NAME" ValueField="CUBE_ID" ValidationSettings-RequiredField-IsRequired="true"  ValidationSettings-Display="Dynamic">
                                                    </dx:ASPxComboBox>
