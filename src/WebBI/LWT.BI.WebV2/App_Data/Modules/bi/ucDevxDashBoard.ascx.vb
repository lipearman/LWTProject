...
Partial Class Modules_ucDevxDashBoard
    ...
    'Protected Sub treeList_NodeDeleting(ByVal sender As Object, ByVal e As DevExpress.Web.Data.ASPxDataDeletingEventArgs) Handles treeList.NodeDeleting
    '    Dim DB_ID = e.Keys("DB_ID")
    ...
    Protected Sub cbDeleteData_Callback(ByVal sender As Object, ByVal e As CallbackEventArgs) Handles cbDeleteData.Callback
        Dim _DSID = e.Parameter.ToString()
        Using dc As New DataClasses_PortalBIExt
            Dim sb As New StringBuilder()


            sb.Append("delete tblDashBoard_Data where DB_GUID Collate THAI_CI_AS in(select GUID from tblDashBoard where DB_ID ='" & _DSID & "');")
            sb.Append("delete tblDashBoard_Assignment where DB_ID='" & _DSID & "';")
            sb.Append("delete tblDashBoard where DB_ID='" & _DSID & "';")
