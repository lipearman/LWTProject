<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxFileBIUser.ascx.vb" Inherits="Modules_ucDevxFileBIUser" %>
        ...
        <dx:PanelContent>
            ...
            <dx:ASPxTreeList ID="treeList" 
                ...
                <Columns>
                 ...
                 <dx:TreeListTextColumn FieldName="ASATDATE" Caption="ASATDATE" PropertiesTextEdit-DisplayFormatString="{0:yyyy-MM-dd}" CellStyle-Wrap="False">
