<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxBIFileLWTAdminDataSourceManager.ascx.vb" Inherits="Modules_ucDevxBIFileLWTAdminDataSourceManager" %>
<script>
...
<%--  <dx:ASPxTokenBox ID="ASPxTokenBox1" runat="server" ClientInstanceName="ASPxTokenBox1"
      Width="100%"   
      AllowCustomTokens="true" 
      ShowDropDownOnFocus="Auto" 
      TextSeparator=";" 
      ValueSeparator=";"  
      DataSourceID="SqlDataSource_COLUMN_NAME" 
      TextField="COLUMN_NAME"  
      ValueField="COLUMN_NAME">
    <TokenRemoveButtonStyle CssClass="removeButton"></TokenRemoveButtonStyle>
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:PortalBIConnection %>"
    SelectCommand="select * from tblDataSourceFile where PortalId=@PortalId">
  <SelectParameters>
                                                ...
                                                <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer4" runat="server">
                                                    ...
                                                    <dx:ASPxButton runat="server" ID="btnAppendData" CausesValidation="false" Image-IconID="actions_insert_16x16office2013"
                                                        ...
                                                        <dx:ASPxButton ID="ASPxButton5" runat="server" CausesValidation="false" Image-IconID="actions_cancel_16x16office2013"
                                                                        Text="Delete Data Source" AutoPostBack="false">
                                                        <ClientSideEvents Click="function(s,e) {
