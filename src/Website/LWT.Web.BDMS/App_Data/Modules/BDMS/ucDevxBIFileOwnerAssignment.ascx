<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxBIFileOwnerAssignment.ascx.vb" Inherits="Modules_ucDevxBIFileOwnerAssignment" %>

<dx:ASPxRoundPanel ID="pnMain" EnableAnimation="true" ShowCollapseButton="true" HeaderText="Report" runat="server" EnableAdaptivity="true" Width="100%" HeaderImage-IconID="businessobjects_bonote_32x32">
    <PanelCollection>
        <dx:PanelContent>
...
where tblDataSourceBI.Owner=@UserName and tblDataSourceBI.PortalId=@PortalId
