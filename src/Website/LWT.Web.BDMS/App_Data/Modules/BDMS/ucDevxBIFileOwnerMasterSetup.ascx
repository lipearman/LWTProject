<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxBIFileOwnerMasterSetup.ascx.vb" Inherits="Modules_ucDevxBIFileOwnerMasterSetup" %>
                            ...
                            <dx:TreeListToolbarItem BeginGroup="true">
                                <Template>
                                    <dx:ASPxButton ID="ASPxButton1" runat="server"
                                        AutoPostBack="false" Border-BorderStyle="Groove" Border-BorderWidth="1" ForeColor="Black" BackColor="White"
...
<asp:SqlDataSource ID="SqlDataSource_DataSourceFile"
    ...
    SelectCommand="
        ...
        select [ID] as [DS_ID] 
        ,[Title]
        from tblDataSourceFile where Owner=@UserName and PortalId=@PortalId
    order by [Title] 
