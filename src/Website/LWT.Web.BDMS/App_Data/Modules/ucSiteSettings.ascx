...
<dx:ASPxRoundPanel ID="pnMain" EnableAnimation="true"
     ShowCollapseButton="true"    HeaderStyle-BackColor="#4796CE" HeaderStyle-ForeColor="White"
...
<%--                    <dx:GridViewDataTextColumn FieldName="cfg_conn" CellStyle-Wrap="True" Visible="false">
          ...
          <%--      <SettingsCommandButton>
                ...
                <SettingsPopup>
                    <EditForm ShowPinButton="true" Modal="true" Width="500" ShowShadow="true" HorizontalAlign="Center" VerticalAlign="Middle" />
                </SettingsPopup>
