        ...
        <nav class="navbar navbar-fixed-top" id="navbar">
           ...
           <%--         <h3><%=sitename%></h3>
                  ...
                  <table style="margin-top: 10px;">
                        <tr>
                            <%--<td style="vertical-align: central; text-align: left; background-color: blue">
                                <img src="images/Lockton-Logo_250.png" height="60" />
                                <img src="images/BDMS/BGH_Thai_English.png" width="200" />
                                <h4><b><%=sitename%></b></h4>
                            </td>
                            <td>&nbsp;
                            </td>--%>
                            <td style="vertical-align: central; text-align: left">
                                <img src="images/BDMS/BDMS45th.png" width="150" />
                                <%--<img src="images/BDMS/BGH_Thai_English.png" width="200" />--%>
                ...
                <h4>
                    <a href="javascript:;" style="pointer-events: none; cursor: default;">
                        <%--<span class="image fa fa-user" aria-hidden="true"></span>--%><span>
                            <dx:ASPxImage ID="ASPxImage1" runat="server" EmptyImage-IconID="businessobjects_bouser_32x32"></dx:ASPxImage>
                            &nbsp;Login</span></a>
                </h4>
