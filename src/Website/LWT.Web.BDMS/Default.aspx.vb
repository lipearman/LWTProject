...
Partial Class _Default
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Response.Write(Portal.Components.Utils.Encrypt("Password123"))
        'Response.End()
    ...
    Protected Sub cbLogin_Callback(ByVal sender As Object, ByVal e As CallbackEventArgs) Handles cbLogin.Callback
        ...
        Using dc As New DataClasses_PortalDataContextExt()
            ...
            Dim _data = (From c In dc.Portal_Users Where c.UserName.Equals(UserName) Select c).FirstOrDefault()
            If _data Is Nothing Then
                e.Result = "No this user in System. Please contact administrator."
                Return
            End If

            If Not _data.IsApproved Then
                e.Result = ("User is not approved. Please contact administrator.")
                Return
            End If

            If _data.IsLocked Then
                e.Result = ("User is Locked. Please contact administrator.")
                Return
            End If
            ...
            Else
                ...
                If Not _data.Password.Equals(Portal.Components.Utils.Encrypt(Password)) Then
                ...
                Else
                    ...
                    If _data.ExpiredDate IsNot Nothing Then
                        ...
                        If DateDiff(DateInterval.Day, _data.ExpiredDate.Value, Now) > 1 Then
                            ...
                            e.Result = "User expired. Please contact administrator."
                            Return
