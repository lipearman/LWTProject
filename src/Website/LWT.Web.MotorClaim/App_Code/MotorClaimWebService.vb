...
Public Class MotorClaimWebService
    ...
    Private Sub InitClaimData(ByRef _data As tblClaimTransaction_Data)
        ...
        If Not String.IsNullOrEmpty(_data.CarReceiveDate) Then _data.CarRepairDate = Left(_data.CarRepairDate.Trim(), 10)
        ...
        Else
            If _data.ShowRoomCode <> "-" Then
                Using dc As New DataClasses_MotorClaimDataContext()
                    ...
                    Dim _showroom = (From c In dc.tblShowRoomCodes Where c.ShowroomID.Equals(_data_showroom) Or c.ShowRoomCode.Equals(_data_showroom)).FirstOrDefault()
    ...
    Public Function ValidateData(ByVal _obj As Object, ByVal _objType As objType) As Object
        ...
        If _obj.GetType().ToString().ToLower().Equals("system.dbnull") Then
