    ...
    Protected Sub btnSaveNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveNew.Click
        ...
        Using dc As New DataClasses_MotorClaimDataExt
            ...
            If _data.Count > 0 Then
                ...
                '1.Create Header
                Dim _newdata_header As New tblNoticeHeader With {.NoticeTitle = "ข้อมูลตรวจสอบเคลม การเกิดเหตุรายสัปดาห์" _
                ...
                dc.tblNoticeHeaders.InsertOnSubmit(_newdata_header)

                '2.Create Details
                For Each item In _data

                    _newdata_header.tblNoticeDetails.Add(New tblNoticeDetail With {.Code = item.ShowRoomCode _
