...
Partial Class Modules_ucDevxNLTHFloorPlanData
    ...
    Private Sub binddata()
        ...
        '============ todo2=======================
        SqlDataSource_gridData.SelectCommand = String.Format("SELECT * FROM V_NLTH_FloorPlan_Daily where  convert(varchar,DateClosing,112) between '{0}' and '{1}' ", DirectCast(DateFrom.Value, Date).ToString("yyyyMMdd"), DirectCast(DateTo.Value, Date).ToString("yyyyMMdd"))
