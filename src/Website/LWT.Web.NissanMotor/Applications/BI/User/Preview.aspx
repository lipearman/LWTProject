...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--  
       ...
       <asp:SqlDataSource ID="ObjectDataSource1" runat="server" ></asp:SqlDataSource>
 <dx:EntityServerModeDataSource ID="ObjectDataSource1" runat="server" ContextTypeName="LargeDatabaseContext" />
 ...
 <%--               <table class="OptionsTable OptionsBottomMargin">
                ...
                <dx:ASPxPivotGrid ID="pivotGrid" runat="server" ClientInstanceName="pivotGrid"
                    ...
                    <OptionsPager AlwaysShowPager="True" Position="Top">
                        <Summary Visible="False" />
                        <PageSizeItemSettings Visible="True" Items="20, 30, 40, 50" ShowAllItem="true">
                        </PageSizeItemSettings>
                    </OptionsPager>

                    <OptionsPager RowsPerPage="20" PageSizeItemSettings-Position="Left" PagerAlign="Left"></OptionsPager>
                    ...
                    <OptionsView
                        ...
                        />
                    <OptionsCustomization AllowPrefilter="false" />
