                ...
                <table id="login" style="width: 1100px; background: none;" class="c">
                    <tr>
                        <td align="right">
                            ...
                            <dx:ASPxButton runat="server" ID="cmdThai" AllowFocus="false" Image-Url="~/res/icon/flag_th.png" Text="Thai" CssClass="TextBoxLogin">
                            </dx:ASPxButton>
                            <dx:ASPxButton runat="server" ID="cmdEnglish" Image-Url="~/res/icon/flag_gb.png" Text="English" Enabled="false" CssClass="TextBoxLogin">
                            </dx:ASPxButton>
                        </td>
                    </tr>
                    <tr>
