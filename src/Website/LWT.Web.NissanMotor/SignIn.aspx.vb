...
Partial Class SignIn
    ...
    Private Sub Page_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Init
        ...
        'Response.Write(Portal.Components.Utils.Encrypt("1kjalahd") & "<br>")
        'Response.Write(Portal.Components.Utils.Encrypt("ur92zrpa") & "<br>")
        'Response.Write(Portal.Components.Utils.Encrypt("kimtt2dk") & "<br>")
        'Response.Write(Portal.Components.Utils.Encrypt("zdncg35y") & "<br>")
        'Response.Write(Portal.Components.Utils.Encrypt("hnuuc1id") & "<br>")
        'Response.Write(Portal.Components.Utils.Encrypt("29z52rhk") & "<br>")
        'Response.Write(Portal.Components.Utils.Encrypt("dyybyd55") & "<br>")
        'Response.End()
            ...
            Else
                ...
                Else
                    ...
                    If _data.ExpiredDate IsNot Nothing Then
                        ...
                        If DateDiff(DateInterval.Day, _data.ExpiredDate.Value, Now) > 1 Then
