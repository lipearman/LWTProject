<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucLWTMotorClaimInbox00.ascx.vb" Inherits="Modules_ucLWTMotorClaimInbox00" %>
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimTransactionData where RankNo=1 and ClaimStatus='00'"></asp:SqlDataSource>
