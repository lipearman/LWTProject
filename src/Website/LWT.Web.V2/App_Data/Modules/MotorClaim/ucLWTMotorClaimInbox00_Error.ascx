<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucLWTMotorClaimInbox00_Error.ascx.vb" Inherits="Modules_ucLWTMotorClaimInbox00_Error" %>
...
<dx:ASPxRoundPanel ID="pnMain" EnableAnimation="true" ShowCollapseButton="true"  HeaderText=""  runat="server" Width="100%">
        ...
        <dx:PanelContent>
            ...
            <dx:ASPxGridView runat="server" 
                ...
                <SettingsPager Mode="ShowPager" PageSize="5">
                    <PageSizeItemSettings Visible="true" Items="5,10, 15, 30, 45" ShowAllItem="false" />
                </SettingsPager>
 ...
 <dx:GridViewDataColumn FieldName="InsurerName" Caption="ประกันภัย" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    

                    <dx:GridViewDataColumn FieldName="App_TempPolicyNo" Width="150"   CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    <%--<dx:GridViewDataColumn FieldName="ResultMessage"  Width="100"  CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />--%>
                    ...
                    --%>
                    <dx:GridViewDataColumn FieldName="ShowRoomCode" Caption="Code" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />

                    <dx:GridViewDataColumn FieldName="ShowRoomName" Width="200" Caption="ShowRoom" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    <dx:GridViewDataColumn FieldName="FullCustomerName" Caption="ผู้เอาประกันภัย" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />

                    <dx:GridViewDataColumn FieldName="CarLicense" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />


                    <dx:GridViewDataColumn FieldName="PolicyNo" Caption="เลขที่กรมธรรม์" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    <dx:GridViewDataColumn FieldName="ClaimNo" Caption="เลขที่เคลม" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    <dx:GridViewDataColumn FieldName="AccidentDate" Caption="วันที่เกิดเหตุ" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    <dx:GridViewDataColumn FieldName="AccidentPlace" Caption="สถานที่เกิดเหตุ" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    <dx:GridViewDataColumn FieldName="EffectiveDate" Caption="วันคุ้มครอง" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    <dx:GridViewDataColumn FieldName="Beneficiary" Caption="ผู้รับผลประโยชน์" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                   <dx:GridViewDataColumn FieldName="NoticeName" Caption="ผู้แจ้งเคลม" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    <dx:GridViewDataColumn FieldName="NoticeTel" Caption="เบอร์โทรผู้แจ้งเคลม" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
                    ...
                    <dx:GridViewDataColumn FieldName="ResultMessage" Width="150" CellStyle-Wrap="False" ExportCellStyle-Wrap="False" />
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimDaily_00_Error"></asp:SqlDataSource>
