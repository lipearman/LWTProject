<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucLWTMotorClaimInbox00_VIRI.ascx.vb" Inherits="Modules_ucLWTMotorClaimInbox00_VIRI" %>
...
<%--<asp:SqlDataSource ID="SqlDataSource_ClaimTransaction_Data" runat="server"
    ...
    SelectCommand="SELECT * FROM tblClaimTransaction_Data where Unwriter='U00121' "></asp:SqlDataSource>--%>
...
<dx:ASPxPopupControl ID="popupResult" runat="server" ClientInstanceName="popupResult"
    Modal="True" Maximized="true" ShowMaximizeButton="true"
        ...
        <dx:PopupControlContentControl ID="PopupControlContentControl1" runat="server">
            ...
            <dx:ASPxGridView runat="server" ID="ASPxGridViewResult" ClientInstanceName="ASPxGridViewResult"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="ClaimType" CellStyle-Wrap="False">
                        <PropertiesComboBox>
                            <Items>
                                <dx:ListEditItem Value="0" Text="-" />
                                <dx:ListEditItem Value="1" Text="เคลมสด" />
                                <dx:ListEditItem Value="2" Text="เคลมแห้ง" />
                            </Items>
                        </PropertiesComboBox>
                    </dx:GridViewDataComboBoxColumn>
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="ClaimResult" CellStyle-Wrap="False">
                        <PropertiesComboBox>
                            <Items>
                                <dx:ListEditItem Value="0" Text="-" />
                                <dx:ListEditItem Value="1" Text="ถูก" />
                                <dx:ListEditItem Value="2" Text="ผิด" />
                                <dx:ListEditItem Value="3" Text="ประมาทร่วม" />
                                <dx:ListEditItem Value="4" Text="รอผลคดี" />
                            </Items>
                        </PropertiesComboBox>
                    </dx:GridViewDataComboBoxColumn>
                    ...
                    <dx:GridViewDataTextColumn FieldName="NoticeTel" CellStyle-Wrap="False" Settings-AllowFilterBySearchPanel="True" />
                    <%--<dx:GridViewDataTextColumn FieldName="GarageType" CellStyle-Wrap="False" Settings-AllowFilterBySearchPanel="True" />--%>
                     <dx:GridViewDataComboBoxColumn FieldName="GarageType" CellStyle-Wrap="False">
                        <PropertiesComboBox>
                            <Items>
                                <dx:ListEditItem Value="0" Text="-" />
                                <dx:ListEditItem Value="1" Text="BP Shop" />
                                <dx:ListEditItem Value="2" Text="Authorized" />
                                <dx:ListEditItem Value="3" Text="Insurance" />
                                <dx:ListEditItem Value="4" Text="Other" />
                            </Items>
                        </PropertiesComboBox>
                    </dx:GridViewDataComboBoxColumn>
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="MotorClaimUploadResult_VIRI" TypeName="MotorClaim.DataClasses_MotorClaimDataExt">
    <SelectParameters>
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimTransactionData where Unwriter='U00121' and RankNo=1 and ClaimStatus='00'"></asp:SqlDataSource>
