<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucLWTMotorClaimInbox02.ascx.vb" Inherits="Modules_ucLWTMotorClaimInbox02" %>
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimTransactionData where RankNo=1 and ClaimStatus='02'"></asp:SqlDataSource>
