<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucLWTMotorClaimInbox98.ascx.vb" Inherits="Modules_ucLWTMotorClaimInbox98" %>
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimTransactionData where RankNo=1 and ClaimStatus='98'"></asp:SqlDataSource>
