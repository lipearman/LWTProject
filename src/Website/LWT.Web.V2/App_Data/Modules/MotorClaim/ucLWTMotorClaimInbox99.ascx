<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucLWTMotorClaimInbox99.ascx.vb" Inherits="Modules_ucLWTMotorClaimInbox99" %>
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimTransactionData where RankNo=1 and ClaimStatus='99'"></asp:SqlDataSource>
