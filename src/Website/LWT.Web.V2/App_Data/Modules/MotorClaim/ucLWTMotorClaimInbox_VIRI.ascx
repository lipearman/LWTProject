<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucLWTMotorClaimInbox_VIRI.ascx.vb" Inherits="Modules_ucLWTMotorClaimInbox_VIRI" %>
     ...
     <PanelCollection>
        <dx:PanelContent>
            ...
            <dx:ASPxGridView runat="server"
                ...
                <ClientSideEvents 
                    CustomizationWindowCloseUp="grid_CustomizationWindowCloseUp"
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimTransactionData where RankNo=1 and Unwriter='U00121'"></asp:SqlDataSource>
...
<asp:SqlDataSource ID="SqlDataSource_Details" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimTransactionData_Details where Unwriter='U00121' and TRID=@TRID">
