<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucUWMotorClaimInbox.ascx.vb" Inherits="Modules_ucUWMotorClaimInbox" %>
...
<dx:ASPxRoundPanel ID="pnMain" EnableAnimation="true" ShowCollapseButton="true" ShowHeader="false" runat="server" Width="100%">
  ...
  <dx:GridViewDataTextColumn FieldName="TRID" Visible="false" Settings-AllowSort="True" SortOrder="Descending" />
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="Unwriter" Caption="Insurer"
...
<asp:SqlDataSource ID="SqlDataSource_gridData" runat="server" ConnectionString="<%$ ConnectionStrings:MotorClaimConnectionString %>"
    SelectCommand="select * from V_ClaimTransactionData where RankNo=1 and Unwriter=@Unwriter  "  >
...
<dx:ASPxPopupControl ID="popupDetails" ClientInstanceName="popupDetails"
    ...
    <ContentCollection>
        <dx:PopupControlContentControl ID="PopupControlContentControl3" runat="server">
            ...
            <dx:ASPxCallbackPanel ID="MailPreviewPanel" runat="server" RenderMode="Div"  ClientInstanceName="ClientMailPreviewPanel">
                <PanelCollection>
