<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxNoticeHeaderSetup_B0022.ascx.vb" Inherits="Modules_ucDevxNoticeHeaderSetup_B0022" %>
                    ...
                    <Rows>
                        ...
                        <f:FormRow runat="server" ID="FormRow8">
                            ...
                            <Items>
                                ...
                                <f:TabStrip ID="TabStrip1" ShowBorder="true" TabPosition="Top" EnableAjax="false"
                                    EnableTabCloseMenu="false" ActiveTabIndex="0"
                                    runat="server">
                                    <Tabs>

                                        <f:Tab ID="Tab1" Title="ข้อมูล" CssClass="formitem"
                                            runat="server">
                                            <Items>
                                        ...
                                        <f:Tab ID="Tab2" Title="เอกสารแนบ" CssClass="formitem" runat="server" Height="700" EnableIFrame="true">
                                        </f:Tab>
    ...
    <Items>
        <f:SimpleForm ID="SimpleForm1" runat="server" ShowBorder="false" BodyPadding="10px" MessageTarget="Qtip"
            ...
            <Items>
                ...
                <f:Label runat="server" ID="lbNewTitle" Label="Title" Text="รายงานตรวจสอบข้อมูลการแจ้งขาย "></f:Label>
                <f:DatePicker runat="server" ID="dpNewNoticeDate" Required="true" Label="วันที่แจ้ง"></f:DatePicker>
...
<f:Window ID="WindowViewAgentData" runat="server" Title="Data" Hidden="true"
    ...
    <Items>
        ...
        <f:Grid ID="dgData" Title="Data" EnableCollapse="true" Width="800px" Height="350px"
            ...
            <Columns>
                <f:RowNumberField />
                <f:BoundField ColumnID="xf02" DataField="f02" HeaderText="M2_SHOWROOM" />
                <f:BoundField ColumnID="xf03" DataField="f03" HeaderText="M2_CHASSIS NO" />
                <f:BoundField ColumnID="xf04" DataField="f04" HeaderText="M2_ENGINE No" />
                <f:BoundField ColumnID="xf05" DataField="f05" HeaderText="M2_Name Surname" />
                <f:BoundField ColumnID="xf06" DataField="f06" HeaderText="Notifigation Date" />
                <f:BoundField ColumnID="xf07" DataField="f07" HeaderText="Effective" />
