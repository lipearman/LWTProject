...
Partial Class Modules_ucDevxNoticeHeaderSetup_B0034

    Inherits PortalModuleControl
    Dim _NoticeCode As String = "B0034"
    '*******************************************************
    '
    ...
    Private Sub BindAgentData()
        Using dc As New DataClasses_CPSExt
            Dim _data = (From c In dc.V_BillingCBCNotifications Where c.NotificationID.Equals(hdNotificationID.Text) Order By c.AgentCode).ToList()
