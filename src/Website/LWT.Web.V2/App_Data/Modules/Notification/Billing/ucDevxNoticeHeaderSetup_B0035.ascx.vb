...
Partial Class Modules_ucDevxNoticeHeaderSetup_B0035

    Inherits PortalModuleControl
    Dim _NoticeCode As String = "B0035"
    '*******************************************************
    '
    ...
    Private Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Page.IsPostBack = False Then
            Using dc_portal As New DataClasses_PortalDataContextExt
                ...
                lbNotificationTitle.Text = _mailNotification.MailSubject

                lbNewTitle.Text = _mailNotification.MailSubject

                tbxNewNoticeTitle.Text = _mailNotification.MailSubject
            End Using
            BindData()
        End If
    End Sub
    ...
    Private Sub BindAgentData()
        Using dc As New DataClasses_CPSExt
            Dim _data = (From c In dc.V_BillingCBCNotification2s Where c.NotificationID.Equals(hdNotificationID.Text) Order By c.AgentCode).ToList()
    ...
    Private Sub WH_genxls(ByVal NotificationID As String, ByVal AgentCode As String)
        ...
        Using dc As New DataClasses_CPSExt
            ...
            Dim pdfTemplate As String = String.Format("{0}/{1}", Server.MapPath("~/template"), "/CBCForDealer.pdf")
            ...
            pdfFormFields.SetField("noticedate1", MyUtils.GenThaiDate(_data.NoticeDate, 2))
            pdfFormFields.SetField("dealername", _AgentName)
            pdfFormFields.SetField("noticedate2", MyUtils.GenThaiDate(_data.DueDate, 2))
            ...
            'barcode1.SetAbsolutePosition(33, 11)
            ...
            'barcode2.SetAbsolutePosition(385, 11)
            ...
            Dim _filename = String.Format("สรุปรายการคงค้าง-{0}_{1}.xls", _AgentName, DateTime.Now.ToString("yyyyMMddHHmmss"))
            ...
            Try
                ...
                Using dc_portal = New DataClasses_PortalDataContextExt
                    ...
                    Dim _MailBody As String = Server.HtmlDecode(_mailNotification.MailBody).Replace("{duedate}", MyUtils.GenThaiDate(_data.DueDate, 2))
                    ...
                    _MailBody = _MailBody.Replace("{amount}", Convert.ToDecimal(sum_f14).ToString("###,##0.00"))
                ...
                att_letter.Name = String.Format("แจ้งยกเลิก รายการคงค้างค่าเบี้ยประกันภัย {0}.pdf", _AgentName)
                ...
                att_data.Name = String.Format("สรุปรายการคงค้าง {0}.xls", _AgentName)
