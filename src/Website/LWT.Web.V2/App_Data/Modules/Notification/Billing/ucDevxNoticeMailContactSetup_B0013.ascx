<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxNoticeMailContactSetup_B0013.ascx.vb" Inherits="Modules_ucDevxNoticeMailContactSetup_B0013" %>
                            ...
                            <PropertiesTextEdit>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="true" />
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="MailCC" Caption="CC"  Width="300">
                                        </dx:GridViewDataTextColumn>
