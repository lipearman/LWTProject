...
Partial Class Modules_ucDevxNoticeMailContactSetup_B0013
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If (Not IsPostBack) Then
            ...
            '    Dim _data = (From c In _dc.ProjectRoleUsers Where c.PortalId = ConfigurationManager.AppSettings("PortalID").ToString() And c.UserName = HttpContext.Current.User.Identity.Name).ToList()
            'End Using
