<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxNoticeMailContactSetup_B0021.ascx.vb" Inherits="Modules_ucDevxNoticeMailContactSetup_B0021" %>
                                ...
                                <dx:ASPxFormLayout ID="ASPxFormLayout1" runat="server">
                                    <Items>
                                       ...
                                       <%--         <dx:LayoutItem Caption="From">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer>
                                                            <dx:ASPxTextBox ID="MailFrom" Width="600" ValidationSettings-RequiredField-IsRequired="true"
                                                                runat="server" />
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                </dx:LayoutItem>--%>
...
<asp:SqlDataSource ID="SqlDataSource_NoticeMailContact" runat="server" ConnectionString="<%$ ConnectionStrings:CPSConnectionString %>"
    ...
    InsertCommand="insert into tblNoticeMailContact(NoticeCode,Code,Name,MailTo,ContactName,IsActive,CreationDate,CreationBy) 
    values(@NoticeCode,@Code,@Name,@MailTo@ContactName,1,getdate(),@UserName)
    "
