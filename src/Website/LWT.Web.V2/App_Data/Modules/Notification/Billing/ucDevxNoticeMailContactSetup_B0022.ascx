<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxNoticeMailContactSetup_B0022.ascx.vb" Inherits="Modules_ucDevxNoticeMailContactSetup_B0022" %>
                    ...
                    <dx:TabPage Text="ผู้ติดต่อ">
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl1" runat="server">
                                <dx:ASPxButton ID="bnUploadAgentXLS"
                                    ClientInstanceName="bnUploadAgentXLS"
                                    AutoPostBack="false"
                                    runat="server"
