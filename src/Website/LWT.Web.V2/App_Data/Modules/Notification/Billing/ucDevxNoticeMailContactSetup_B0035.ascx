<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxNoticeMailContactSetup_B0035.ascx.vb" Inherits="Modules_ucDevxNoticeMailContactSetup_B0035" %>
 

<dx:ASPxRoundPanel ID="pnMain" EnableAnimation="true" ShowCollapseButton="true" HeaderText="Dealer/Showroom" runat="server" Width="100%">
    <PanelCollection>
        <dx:PanelContent>
