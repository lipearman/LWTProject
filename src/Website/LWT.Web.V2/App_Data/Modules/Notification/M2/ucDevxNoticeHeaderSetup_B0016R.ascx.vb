...
Partial Class Modules_ucDevxNoticeHeaderSetup_B0016R
    Inherits PortalModuleControl
    Dim _MailNotifications_Amend As String = "B0015R"
    'Dim _MailNotifications_Endorse As String = "B0016"

    Dim _NoticeCode As String = "B0016R"
    ...
    Private Sub importdata()
        ...
        While line IsNot Nothing
            ...
            Dim _data = (From c In dc_TIDMotor.V_MotorEndorsements Where c.REFNO.Equals(_REFNO) And c.Motor.Equals("M1")).FirstOrDefault()

            'Dim _data = (From c In dc_SIBIS.Clients Where c.Client.Equals(_clientcode)).FirstOrDefault()

            'If _clientcode = "NL563UM0" Then
            ...
            Else
                ...
                With _itemdata
                    ...
                    .f15 = _Ament(0).ToString().Trim()
                    .f11 = _Ament(1).ToString().Trim() 'f11 Amendment Details
    ...
    Private Sub ExportData_Amend(ByVal _NotificationID As String)
        Using dc As New DataClasses_CPSExt
            ...
            row2.GetCell(1).SetCellValue(_OwnerName & "  Affinity & SMEs Department ชั้น 4")
            '================== create row ===================
            j += 1
            ...
            row6.GetCell(0).SetCellValue("A&S")
            ...
            row6.GetCell(3).SetCellValue("Benchawan")
    ...
    Private Sub WH_genxls_Amend(ByVal NotificationID As String)
        ...
        Using dc As New DataClasses_CPSExt
            ...
            row2.GetCell(0).SetCellValue("FR.")
            row2.CreateCell(1).CellStyle = Row_Style_BOLD
            row2.GetCell(1).SetCellValue(_displayName & "  Affinity & SMEs Department ชั้น 4")
            '================== create row ===================
            j += 1
            Dim row3 As IRow = sheet1.CreateRow(j)
            '================== create row ===================
