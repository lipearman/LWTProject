...
Partial Class Modules_ucDevxNoticeHeaderSetup_B0019N
    Inherits PortalModuleControl
    Dim _NoticeCode As String = "B0019N"
    '*******************************************************
    '
    ...
    Private Sub importdata()
        ...
        Using dc As New DataClasses_NLTDB_LWTReportsExt
            ...
            While line IsNot Nothing
                ...
                Dim _data = (From c In dc.V_M2_Applications Where c.REFNO.Equals(_IDCodeCRV)).FirstOrDefault()
