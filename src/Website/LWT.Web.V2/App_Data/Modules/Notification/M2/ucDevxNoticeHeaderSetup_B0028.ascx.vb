...
Partial Class Modules_ucDevxNoticeHeaderSetup_B0028
    
    Inherits PortalModuleControl
    Dim _NoticeCode As String = "B0028"
    '*******************************************************
    '
    ...
    Protected Sub btnExcelFormat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExcelFormat.Click
        ...
        Dim filePath = String.Format("{0}\{1}", Server.MapPath("~/Template"), "Template for NMT2.xls")
    ...
    Protected Sub btnSaveNew_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSaveNew.Click
        ...
        Using dc As New DataClasses_CPSExt
            ', .DataFields = "[Dealer Name],[Chassis No.],[Engine No.],[Customer's Thai Name],[Sold Date],[เลขที่รับแจ้ง],[วันที่แจ้งประกัน]" _
    ...
    Private Sub importdata()
        ...
        Using dc As New DataClasses_CPSExt
            ...
            While line IsNot Nothing
                ...
                '[Dealer Name],[Chassis No.],[Engine No.],[Customer's Thai Name],[Sold Date],[เลขที่รับแจ้ง],[วันที่แจ้งประกัน]
    ...
    Private Sub WH_genxls(ByVal NotificationID As String, ByVal AgentCode As String)
        ...
        Using dc As New DataClasses_CPSExt
            ...
            '================== create column ===================
            Dim _fields = "Dealer Name,Chassis No.,Engine No.,Customer's Thai Name,Sold Date,เลขที่รับแจ้ง,วันที่แจ้งประกัน".Split(",")
            ...
            Dim _filename = String.Format("ตรวจสอบการแจ้งประกันภัย-{0}_{1}.xls", _AgentName, DateTime.Now.ToString("yyyyMMddHHmmss"))
            ...
            Try
                ...
                Using dc_portal = New DataClasses_PortalDataContextExt
                    ...
                    Dim _MailBody As String = Server.HtmlDecode(_mailNotification.MailBody).Replace("{freetext}", _data.NoticeTitle).Replace("{duedate1}", MyUtils.GenThaiDate(_data.DueDate, 2)).Replace("{duedate2}", MyUtils.GenThaiDate(_data.DueDate, 2)).Replace("{duedate3}", MyUtils.GenThaiDate(_data.DueDate, 2))
                    ...
                    'strMailTo = "rangsinee@asia.lockton.com;laddawan@asia.lockton.com;dusit@asia.lockton.com"
                End Using
                ...
                att_data.Name = String.Format("ตรวจสอบการแจ้งประกันภัย-{0}.xls", _AgentName)
