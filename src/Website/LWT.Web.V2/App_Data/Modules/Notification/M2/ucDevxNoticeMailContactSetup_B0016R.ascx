<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxNoticeMailContactSetup_B0016R.ascx.vb" Inherits="Modules_ucDevxNoticeMailContactSetup_B0016R" %>
            ...
            <dx:ASPxPageControl ID="TabPage" runat="server" ActiveTabIndex="0" EnableHierarchyRecreation="True">
                    ...
                    <dx:TabPage Text="ผู้ติดต่อ">
                        <ContentCollection>
                            <dx:ContentControl ID="ContentControl1" runat="server">
                                ...
                                <dx:ASPxButton ID="btnPopup" runat="server" Text="เพิ่มบริษัทประกันภัย" Image-IconID="actions_add_16x16">
                ...
                <Image IconID="export_exporttoxlsx_16x16"></Image>
                               ...
                               SettingsBehavior-ColumnResizeMode="Control"      
                                    KeyFieldName="ID" AutoGenerateColumns="False" Width="1100">
                            ...
                            <PropertiesTextEdit>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="true" />
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="Code" Caption="รหัส" ReadOnly="true" Width="70" >
                                        </dx:GridViewDataTextColumn>


                                        <dx:GridViewDataTextColumn FieldName="Name" CellStyle-Wrap="False" Caption="ชื่อบริษัทประกันภัย" Width="300" >
                                            <PropertiesTextEdit>
                                                <ValidationSettings Display="Dynamic">
                                                    <RequiredField IsRequired="true" />
                                                </ValidationSettings>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="MailTo" CellStyle-Wrap="False" Caption="To"  Width="300">
                                         ...
                                         <dx:GridViewDataTextColumn FieldName="M1Code" Caption="รหัส M1" Width="70" PropertiesTextEdit-ValidationSettings-RequiredField-IsRequired="true" >
                                        </dx:GridViewDataTextColumn>
                ...
                <Styles>
                    ...
                    <dx:TabPage Text="Email แจ้ง Endorse">
                        <ContentCollection>
...
<%--                                                <dx:LayoutItem Caption="BCC">
                     ...
                     <dx:TabPage Text="Email แจ้ง Amend">
                        <ContentCollection>
                                        ...
                                        <dx:LayoutGroup Caption="Email">
                                            <Items>
                                                <dx:LayoutItem Caption="Subject">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer>
                                                            <dx:ASPxTextBox ID="MailSubject_Amend" Width="600" ValidationSettings-RequiredField-IsRequired="true"
                                                                runat="server" />
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                </dx:LayoutItem>
<%--                                                <dx:LayoutItem Caption="From">
                                                ...
                                                <dx:LayoutItem Caption="To">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer>
                                                            <dx:ASPxTextBox ID="MailTo_Amend" Width="600"
                                                                runat="server" />
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                </dx:LayoutItem>
                                                <dx:LayoutItem Caption="CC">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer>
                                                            <dx:ASPxTextBox ID="MailCC_Amend" Width="600"
                                                                runat="server" />
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                </dx:LayoutItem>
<%--                                                <dx:LayoutItem Caption="BCC">
                                                ...
                                                <dx:LayoutItem Caption="Body">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer>
                                                            <dx:ASPxHtmlEditor ID="MailBody_Amend" runat="server" ValidationSettings-RequiredField-IsRequired="true">
                                                            </dx:ASPxHtmlEditor>
                                                        </dx:LayoutItemNestedControlContainer>
                                                    </LayoutItemNestedControlCollection>
                                                </dx:LayoutItem>
                                                <dx:LayoutItem Caption=" ">
                                                    <LayoutItemNestedControlCollection>
                                                        <dx:LayoutItemNestedControlContainer>
                                                            <dx:ASPxButton ID="ASPxButton2" runat="server" Text="Save" AutoPostBack="false"
                                                                ValidationContainerID="ASPxFormLayout1">
                                                                <ClientSideEvents Click="function(s, e) {
                                                                    if(ASPxClientEdit.AreEditorsValid()) 
                                                                    {                                              
                                                                        LoadingPanel.Show();
                                                                        cbSaveEmail_Amend.PerformCallback('');
                                                                    }
                                                                    else
                                                                    {
                                                                        alert('กรุณากรอกข้อมูลให้ครบ');
                                                            ...
                                                            <dx:ASPxCallback runat="server" ID="cbSaveEmail_Amend" ClientInstanceName="cbSaveEmail_Amend">
                                                                <ClientSideEvents 
                                                                    CallbackError="function(s,e){LoadingPanel.Hide(); }" 
                                                                    CallbackComplete="function(s,e){ 
                                                                     LoadingPanel.Hide();   
                                                            ...
                                                            <dx:ASPxButton ID="ASPxButton3" runat="server" Text="Test Send Mail" AutoPostBack="false" >
                                                                <ClientSideEvents Click="function(s, e) {
                                                                    LoadingPanel.Show();
                                                                    cbTestSendEmail_Amend.PerformCallback('');
                                                                    e.processOnServer = false;
                                                                }" />


                                                            </dx:ASPxButton>
                                                             <dx:ASPxCallback runat="server" ID="cbTestSendEmail_Amend" ClientInstanceName="cbTestSendEmail_Amend">
                                                                <ClientSideEvents 
                                                                    CallbackError="function(s,e){LoadingPanel.Hide(); }" 
                                                                    CallbackComplete="function(s,e){ 
                                                                     LoadingPanel.Hide();   
...
<asp:SqlDataSource ID="SqlDataSource_NoticeMailContact" runat="server" ConnectionString="<%$ ConnectionStrings:CPSConnectionString %>"
    ...
    InsertCommand="insert into tblNoticeMailContact(NoticeCode,Code,Name,MailTo,ContactName,IsActive,CreationDate,CreationBy,M1Code) 
    values(@NoticeCode,@Code,@Name,@MailTo,@ContactName,1,getdate(),@UserName,@M1Code)
    "
            ...
            <dx:ASPxFormLayout ID="frmNew" ClientInstanceName="frmNew" Width="100px" runat="server" AlignItemCaptionsInAllGroups="True" ColCount="1" RequiredMarkDisplayMode="None" ShowItemCaptionColon="False">
                ...
                <Items>
                        ...
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer
                                ...
                                <dx:ASPxGridLookup ID="GridUWLookup" runat="server"
                                    ...
                                    KeyFieldName="Underwriter" Width="300"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataColumn FieldName="AccountContact" Width="500" CellStyle-Wrap="False" Settings-AutoFilterCondition="Contains" />
                                    </Columns>
                                </dx:ASPxGridLookup>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                  ...
                  <%--  <dx:LayoutItem Caption="MailCC">
                    ...
                    <dx:LayoutItem Caption="M1CODE">
                        <LayoutItemNestedControlCollection>
                            <dx:LayoutItemNestedControlContainer ID="LayoutItemNestedControlContainer4" runat="server" SupportsDisabledAttribute="True">
                                <dx:ASPxTextBox runat="server" Width="300" ID="newM1Code" ValidationSettings-RequiredField-IsRequired="true"></dx:ASPxTextBox>
                            </dx:LayoutItemNestedControlContainer>
                        </LayoutItemNestedControlCollection>
                    </dx:LayoutItem>
...
<asp:SqlDataSource ID="SqlDataSource_UW" runat="server" ConnectionString="<%$ ConnectionStrings:CPSConnectionString %>"
    SelectCommand="select rtrim([Underwriter]) as [Underwriter], rtrim([Name]) as [Name],rtrim([AccountContact]) as [AccountContact] 
    from [Register.Unwriter] 
    where IsActive = 1 and InsuranceLine = 2  
    order by Underwriter
    "></asp:SqlDataSource>



<asp:SqlDataSource ID="SqlDataSource_UWLookup" runat="server" ConnectionString="<%$ ConnectionStrings:CPSConnectionString %>"
    SelectCommand="select rtrim([Underwriter]) as [Underwriter], rtrim([Name]) as [Name],rtrim([AccountContact]) as [AccountContact] 
    from [Register.Unwriter] 
    where IsActive = 1 and InsuranceLine = 2 
    and Underwriter not in(select Code from tblNoticeMailContact where NoticeCode=@NoticeCode )
    order by Underwriter
    ">
    <SelectParameters>
        <asp:Parameter Name="NoticeCode" />
