...
Partial Class Modules_ucDevxNoticeMailContactSetup_B0016R
    Inherits PortalModuleControl
    Private NoticeCode As String = "B0016R"
    Private NoticeCode_Amend As String = "B0015R"
    ...
    Private Sub LoadEmailTemplate_Amend()
        Using _dc As New DataClasses_PortalDataContextExt()

            Dim data = (From c In _dc.MailNotifications Where c.Code.Equals(NoticeCode_Amend)).FirstOrDefault()
            With data
                MailSubject_Amend.Text = .MailSubject
                'MailFrom.Text = .MailFrom
                MailTo_Amend.Text = .MailTo
                MailCC_Amend.Text = .MailCC
                'MailBcc.Text = .MailBcc
                MailBody_Amend.Html = Server.HtmlDecode(.MailBody)
    ...
    Protected Sub cbSaveAddNew_Callback(ByVal source As Object, ByVal e As CallbackEventArgs) Handles cbSaveAddNew.Callback
        ...
        Using _dc As New DataClasses_CPSExt()
            ...
            With newData
                .Code = GridUWLookup.Value.Trim()
                .Name = GridUWLookup.Text.Trim().Replace(.Code + " -", "").Trim()
    ...
    Private Sub testsendmail()
        Using _dc As New DataClasses_PortalDataContextExt()
            ...
            Try
                ...
                ''================== mail from ================
                'strMailFrom = data.Email
                ''================== mail to ================
                'strMailTo = strMailFrom
    ...
    Protected Sub cbSaveEmail_Amend_Callback(ByVal source As Object, ByVal e As CallbackEventArgs) Handles cbSaveEmail_Amend.Callback

        Using _dc As New DataClasses_PortalDataContextExt()

            Dim data = (From c In _dc.MailNotifications Where c.Code.Equals(NoticeCode_Amend)).FirstOrDefault()
            With data
                .MailSubject = MailSubject_Amend.Text
                '.MailFrom = MailFrom.Text
                .MailTo = MailTo_Amend.Text
                .MailCC = MailCC_Amend.Text
                '.MailBcc = MailBcc.Text
                .MailBody = Server.HtmlEncode(MailBody_Amend.Html)
            End With
    ...
    Protected Sub cbTestSendEmail_Amend_Callback(ByVal source As Object, ByVal e As CallbackEventArgs) Handles cbTestSendEmail_Amend.Callback
    ...
    Private Sub testsendmail_Amend()
        Using _dc As New DataClasses_PortalDataContextExt()
            ...
            Try
                ...
                Dim data = (From c In _dc.Portal_Users Where c.UserName.Equals(HttpContext.Current.User.Identity.Name)).FirstOrDefault()
                Dim _mailNotification = (From c In _dc.MailNotifications Where c.Code.Equals(NoticeCode_Amend)).FirstOrDefault()
                '================== Subject ================
                strSubject = _mailNotification.MailSubject
                ''================== mail from ================
                'strMailFrom = data.Email
