<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ucDevxNoticeMailContactSetup_B0019.ascx.vb" Inherits="Modules_ucDevxNoticeMailContactSetup_B0019" %>
                            ...
                            <PropertiesTextEdit>
                                <ValidationSettings Display="Dynamic">
                                    <RequiredField IsRequired="true" />
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="Name" CellStyle-Wrap="False" Caption="ชื่อบริษัทประกันภัย" Width="200" >
                                            <PropertiesTextEdit>
                                                <ValidationSettings Display="Dynamic">
                                                    <RequiredField IsRequired="true" />
                                                </ValidationSettings>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="MailTo" CellStyle-Wrap="False" Caption="To"  Width="250">
                                            <PropertiesTextEdit>
                                                <ValidationSettings Display="Dynamic">
                                                    <RequiredField IsRequired="true" />
                                                </ValidationSettings>
                                        ...
                                        <dx:GridViewDataTextColumn FieldName="MailCC" Caption="CC"  Width="250">
                                        </dx:GridViewDataTextColumn>
...
<asp:SqlDataSource ID="SqlDataSource_NoticeMailContact" runat="server" ConnectionString="<%$ ConnectionStrings:CPSConnectionString %>"
    ...
    InsertCommand="insert into tblNoticeMailContact(NoticeCode,Code,Name,MailTo,MailCC,ContactName,IsActive,CreationDate,CreationBy,M1Code) 
    values(@NoticeCode,@Code,@Name,@MailTo,@MailCC,@ContactName,1,getdate(),@UserName,@M1Code)
    "
