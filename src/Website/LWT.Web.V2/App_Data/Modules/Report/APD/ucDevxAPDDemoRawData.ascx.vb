...
Partial Class Modules_ucDevxAPDDemoRawData
    ...
    Private Sub binddata()
        ...
        '============ todo2=======================
        SqlDataSource_gridData.SelectCommand = String.Format("SELECT ROW_NUMBER() OVER(ORDER BY EFFECTIVEDATE) AS [RowNo], * FROM tblMazdaNew where  convert(varchar,EFFECTIVEDATE,112) between '{0}' and '{1}' ", DirectCast(DateFrom.Value, Date).ToString("yyyyMMdd"), DirectCast(DateTo.Value, Date).ToString("yyyyMMdd"))
