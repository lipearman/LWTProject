        ...
        <dx:PanelContent>
            ...
            <dx:ASPxTreeList ID="treeList" ClientInstanceName="treeList" runat="server" AutoGenerateColumns="false" Width="900"
                ...
                <Columns>
                    ...
                    <dx:TreeListTextColumn FieldName="TITLE" Caption="Report" Width="200"  >
                        <PropertiesTextEdit>
                    ...
                    <dx:TreeListMemoColumn FieldName="DESCRIPTION" Width="200"  >
                    ...
                    <dx:TreeListComboBoxColumn FieldName="VIEW_ID" Caption="Data Source" >
