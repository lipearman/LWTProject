...
<script>
    ...
    function OnFocusedCardChanged() {
        if (cardView.GetFocusedCardIndex() > -1) {
            ASPxSplitter1.SetVisible(true);
            LoadingPanel.Show();
            cardView.GetCardValues(cardView.GetFocusedCardIndex(), 'UserName', OnGetCardValues);
        }
        else {
            LoadingPanel.Hide();
            ASPxSplitter1.SetVisible(false);
        }
    }
    ...
    <PanelCollection>
        <dx:PanelContent>
            ...
            <dx:ASPxCardView ID="cardView" ClientInstanceName="cardView" runat="server"  DataSourceID="SqlDataSource_User"
                Width="1000" KeyFieldName="UserName">
                ...
                <SettingsSearchPanel Visible="true"  AllowTextInputTimer="true" /> 
                <Columns>
                    <dx:CardViewColumn>
                        <DataItemTemplate>
                            <dx:ASPxImage ID="ASPxImage1" runat="server" Width="100" ImageUrl="~/images/user.png"></dx:ASPxImage>
                        </DataItemTemplate>
                    </dx:CardViewColumn>
                    <dx:CardViewColumn FieldName="UserName" Caption="UserName" Settings-AllowFilterBySearchPanel="False" />
                    <dx:CardViewColumn FieldName="Email" Caption="Email" />
             ...
             <%--   <CardLayoutProperties ColCount="1">
                    <Items>
                         <dx:CardViewColumnLayoutItem Caption="" ColSpan="1" HorizontalAlign="Center">
                            <Template> 
                                <dx:ASPxImage runat="server" Width="100" ImageUrl="~/images/user.png"></dx:ASPxImage>
                            </Template>
                        </dx:CardViewColumnLayoutItem>
                        <dx:CardViewColumnLayoutItem ShowCaption="False" HorizontalAlign="Center">
                            <Template>
                                <center><%# Eval("UserName")%> <br /> (<%# Eval("Email")%>)</center>
                            </Template>
                        </dx:CardViewColumnLayoutItem>
                    </Items>
