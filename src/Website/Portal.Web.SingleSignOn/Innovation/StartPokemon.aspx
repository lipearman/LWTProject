<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StartPokemon.aspx.vb" Inherits="Portal.Web.SingleSignOn.StartPokemon" %>
    ...
    <script>
        ...
        function animateCaptureState() {
            ...
            setTimeout(function() {
                ...
                if (1) {
                //if (seed-10 < Math.floor(successRate)) {
                    cbPokemon.PerformCallback('1');
                    ...
                    captureStatus.innerHTML = "Yes, INNOVATION.";
                    makeItRainConfetti();
    ...
    <style>
        ...
        * {
        ...
        #target {
            ...
            background-image: url("img/<%=Session("CssPokemonImg")%>");
            background-repeat: no-repeat;
            background-position: center center;
            background-size: cover;
            z-index: 2;
        ...
        <dx:ASPxCallback ID="cbPokemon" runat="server" ClientInstanceName="cbPokemon">
