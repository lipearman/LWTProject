...
Public Class APDKawa2UW
        ...
        If JobDate >= JobStart And JobDate <= JobEnd And IO.File.Exists(logfile) = False Then
            Using dc As New DataClasses_MCYDataContext(System.Configuration.ConfigurationManager.ConnectionStrings("APDKawa2UWVB.My.MySettings.LWTReportsConnectionString").ConnectionString)
                ...
                If Not Today.ToString("dddd").ToLower().Equals("saturday") And Not Today.ToString("dddd").ToLower().Equals("sunday") Then
                    ...
                    Dim _data = (From c In dc.V_KAWA2_UW_Non_ASIAs Where c.Renew = False).ToList()
                    ...
                    '============================ ASIA ===========================
                    Dim _data_asia = (From c In dc.V_KAWA2_UW_ASIAs Where c.Renew = False).ToList()
    ...
    Private Sub WH_genxls_ASIA(ByVal _UWCode As String, ByVal _Data As List(Of V_KAWA2_UW_ASIA))
        ...
        Using dc_portal = New DataClasses_PortalDataContext(System.Configuration.ConfigurationManager.ConnectionStrings("APDKawa2UWVB.My.MySettings.PortalConnectionString").ConnectionString)
        ...
        att_data.Name = String.Format("สรุปงานวันที่ {0} {1}.xls", DataDate, _Insurer.UWName)
