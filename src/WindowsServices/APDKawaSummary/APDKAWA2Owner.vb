...
Public Class APDKAWA2Owner
    ...
    Private Function SaveToExcel()
        ...
        viewer.ServerReport.ReportPath = "/Reports/rptKAWA2Owner"
    ...
    Private Sub WH_genxls(ByVal ZipFile As String)
        Dim _NoticeCode As String = "B0033"
        ...
        Using dc_portal = New DataClasses_PortalDataContext(System.Configuration.ConfigurationManager.ConnectionStrings("APDKawaSummaryVB.My.MySettings.PortalConnectionString").ConnectionString)
        ...
        Dim att_data = New Attachment(ZipFile, "application/vnd.ms-excel")
        att_data.Name = String.Format("{0}.xls", "สรุปยอดขายประจำเดือน Kawasaki")
        ...
        att_data.TransferEncoding = System.Net.Mime.TransferEncoding.QuotedPrintable
