...
Public Class APDM2HoldCover2Insurer
    ...
    Dim _NoticeCode As String = "B0040"
    ...
    Private Sub RunJob()
        ...
        If JobDate >= JobStart And JobDate <= JobEnd And IO.File.Exists(logfile) = False Then
            ...
            Using dc As New DataClasses_LWTReportsDataContext()
                ...
                Dim _dataM2 = (From c In dc.Rawdata_M2_HoldCover_InsurerReport_Dailies).ToList()
                If _dataM2.Count > 0 Then
                    ...
                    Using dc_cps As New DataClasses_CPSDataContext()
                        Dim _M2Insurers = (From c In dc_cps.tblNoticeMailContacts Where c.NoticeCode.Equals(_NoticeCode) _
                              Group By InsurerCode = c.Code _
                              Into g = Group _
                              Select InsurerCode _
                        ).ToList()

                        For Each _M2InsurerCode In _M2Insurers
                            If _dataM2.Where(Function(c) c.InsurerCode.Equals(_M2InsurerCode)).Count > 0 Then
    ...
    Private Function SaveToExcelM2(ByVal InsurerCode As String)
        ...
        viewer.ServerReport.ReportPath = "/Reports/rptM2HoldCoverInsurer"
    ...
    Private Sub WH_genxls(ByVal _InsurerCode As String, ByVal _InsurerAttachFiles As List(Of InsurerAttachFiles))
        ...
        Using dc_portal = New DataClasses_PortalDataContext()
            ...
            Using dc_CPS As New DataClasses_CPSDataContext()
                ...
                _MailBody = _MailBody.Replace("{contact}", _Insurer.ContactName)
                ...
                For Each item In _AttachFiles
                    ...
                    'End If
                    _AttachFile.Name = String.Format("HoldCover-{0}.xls", _Insurer.Name)
