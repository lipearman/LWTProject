...
Public Class ASProductionBudget
    ...
    Private Sub RunJob()
        ...
        If JobDate >= JobStart And JobDate <= JobEnd And IO.File.Exists(logfile) = False Then
            ...
            If datacount > 0 Then
                ...
                If File.Exists(FileName1) And File.Exists(FileName2) Then
                    WH_genxls(FileName1, FileName2)
                End If
    ...
    Private Sub WH_genxls(ByVal File1 As String, ByVal File2 As String)
        Dim _NoticeCode As String = "B0036"
