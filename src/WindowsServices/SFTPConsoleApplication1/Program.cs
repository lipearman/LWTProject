    ...
    class Program
    {
        ...
        static void sftp_gen()
        {
            ...
            using (var dc = new DataClasses_afwnltDataContext())
            {
                ...
                var arrResults = dc.ExecuteQuery<vw_RetailSalesJP>("select distinct * FROM vw_RetailSalesJP where CONVERT(varchar(6), ClosingDate,112) = '" + file_m.Left(6) + "' or CONVERT(varchar(6), AFWMakeDate,112) = '" + file_m.Left(6) + "' ").ToList();

                //Console.WriteLine("select distinct * FROM vw_RetailSalesJP where CONVERT(varchar(6), ClosingDate,112) = '" + file_m.Left(6) + "' or CONVERT(varchar(6), AFWMakeDate,112) = '" + file_m.Left(6) + "' ");
                        ...
                        try
                        {
                            ...
                            if (client.IsConnected)
                            {
                                ...
                                try
                                {
                                    ...
                                    mail.Subject = String.Format("Request NPP data as of {0} (Weekly)", DateTime.Now.ToString("dd MMM yyyy"));
